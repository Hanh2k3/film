    ...
    <div class="col-md-12 g_container">
        ...
        <form action="{{ route('adminfilm.update', $getfilm->film_id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group col-4 mb-3">
                ...
                <select name="category_film" class="form-control">
                    @foreach ($category_film as $key)
                        <option @if ($getfilm->category_id == $key->category_id) {{ 'selected' }} @endif value="{{ $key->category_id }}">
            ...
            <div class="form-group col-3 mb-3">
                ...
                @if (isset($getfilm))
                    <img src="{{ asset('uploads/avatar_film/' . $getfilm->img) }}" alt=""
            ...
            <div class="form-group col-4 mb-3">
                ...
                <input type="text" name="episodes_quantity" class="form-control"
                    value="{{ $getfilm->episodes_quantity }}">
            </div>
            <div class="form-group col-4 mb-3">
